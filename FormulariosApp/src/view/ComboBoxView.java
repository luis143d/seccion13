...
public class ComboBoxView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(etiResultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 390, 30));

        cboPuntosCardinales.setEditable(true);
        cboPuntosCardinales.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Este", "Oeste", "Norte", "Sur" }));
        cboPuntosCardinales.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboPuntosCardinalesActionPerformed(evt);
            }
        });
        jPanel1.add(cboPuntosCardinales, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, -1, -1));
